    ...
    <body id="body">
        ...
        <div class="pestanas">
            <div class="tabs" id="tab0">
                ...
                <button class="tab-button" onclick="changeTab(2)">Cambiar contraseña</button>
            </div>
            <div class="tabs" id="tab1">
                <button class="tab-button" onclick="changeTab(3)">Usuarios</button>
                <button class="tab-button" onclick="changeTab(4)">Porcinos</button>
                <button class="tab-button" onclick="changeTab(5)">Lotes</button>
                <button class="tab-button" onclick="changeTab(6)">Corral</button>
                <button class="tab-button" onclick="changeTab(7)">Porcinos Muertos</button>
            </div>
            <div class="tabs" id="tab2">
                <button class="tab-button" onclick="changeTab(8)">Reproduccion</button>
                <button class="tab-button" onclick="changeTab(9)">Etapa Porcino</button>
            </div>
            <div class="tabs" id="tab3">
                <button class="tab-button" onclick="changeTab(10)">Alimentacion</button>
                <button class="tab-button" onclick="changeTab(11)">Crear Alimento</button>
            </div>
            <div class="tabs" id="tab4">
                <button class="tab-button" onclick="changeTab(12)"> Grafico porcino</button>
                <button class="tab-button" onclick="changeTab(13)">Graficos otro</button>
                <button class="tab-button" onclick="changeTab(14)">opciones4</button>
            </div>
            
            <div class="tabs" id="tab5">
                <button class="tab-button" onclick="changeTab(15)">Reportes</button>
            </div>            
        </div>
        <div class="contenidos">
            ...
            <div id="tabContent2" class="tab-content">
                <iframe src="../Listados/Tabla_SuperAdmin.jsp" width="250px" height="250px" frameborder="1"></iframe>
            </div>
            <div id="tabContent2" class="tab-content">
            ...
            <div id="tabContent2" class="tab-content">
                <iframe src="../Listados/Tabla_alimento.jsp" width="250px" height="250px" frameborder="1"></iframe>
            </div>
            ...
            <div id="taby6" class="tab-content">
                <iframe src="../vistas/Mi_Sesion.jsp" width="250px" height="250px" frameborder="1"></iframe>
            </div>
        
        </div>   
        <script src="../javascript/Inicio_Admin.js" type="text/javascript"></script>
    </body>
</html>
