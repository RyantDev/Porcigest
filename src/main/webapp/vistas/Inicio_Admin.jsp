    ...
    <body id="body">
        ...
        <div class="pestanas">
            ...
            <div class="tabs" id="tab2">
                ...
                <button class="tab-button" onclick="changeTab(9)">Etapa Del Porcino</button>
        ...
        <div class="contenidos">
            ...
            <div id="tabContent3" class="tab-content">
                <iframe src="Cambiar_contraseña.jsp" width="250px" height="250px" frameborder="1"></iframe>
            </div>
            <div id="tabContent1" class="tab-content">
                <iframe src="../Listados/Tabla_usuario.jsp" width="250px" height="250px" frameborder="1"></iframe>
            </div>
            <div id="tabContent2" class="tab-content">
