...
<html>
    ...
    <body>
        ...
        <table id="tabla" class="table table-bordered order-table">
            ...
            <tbody>  
                <%
                    ResultSet Resultado = ObjectoUsuarios.LitadoUsuariosAdmin();
                ...
                <tr>
                    ...
                    <td>
                        <form id="formEliminar_<%= cedula%>" action="./../Eliminar/EliminarUsuario.jsp?cedula=<%= cedula%>" method="post">
                ...
                <form action="./../Modificar/ModificarUsuarios.jsp" method="post" id="formulario"  onsubmit="return MiFuncion()">
                    <div class="formulario" >
                        ...
                        <div class="formulario__grupo" id="grupo__tipo_rol">
                            <label for="nombre" class="formulario__label">Tipo Rol</label>
